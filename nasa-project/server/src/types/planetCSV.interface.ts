export type PlanetDisposition = 'CONFIRMED' | 'CANDIDATE' | 'FALSE POSITIVE';

export default interface PlanetCSV {
  kepler_name: string;
  koi_disposition: PlanetDisposition;
  koi_pdisposition: PlanetDisposition;
  koi_score: string;
